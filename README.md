<h2 align="left">Hi there, Welcome to my room!</h2>

###
<p <br>An Insight-driven Data Analyst and Certified SQL Professional who transforms complex data into immediate business value. Recognized for designing streamlined dashboards that deliver clear answers in under 60 seconds, notably reducing executive decision-making delays by up to 4 hours per day. Proven track record of building predictive inventory models for e-commerce and analyzing 55,000+ healthcare records to optimize insurance targeting. Combines a rigorous mathematical background with Power BI, Tableau, and Excel to deliver simple, actionable strategies for organizational growth.<br><br>🔍 Areas I Focus On:<br>- 📊 Business Intelligence Reporting & Dashboard Design  <br>- 🧹 Data Cleaning & Preprocessing (ETL)  <br>- 🗃️ Database Management & Querying (SQL)  <br>- 📈 Data Visualization & Storytelling  <br>- 🤖 Automation of Repetitive Data Tasks  <br>- 📉 Statistical Analysis & Data-Driven Insights  <br>- 💼 Decision Support for Business Strategy  <br><br>Whether it's helping you understand your business performance or working with your teams to streamline data pipelines, I’m passionate about making data clear, actionable, and valuable.<br><br>Let’s connect and help you turn raw data into powerful stories!</p>
